            ...
            content: [
              {
                type: 'input_text',
                text:
                  'You suggest well-known, recurring, toddler-friendly (ages 1 to 3) events, programs, and family attractions across the whole Dallas-Fort Worth (DFW) metroplex for the date range ' +
                  window.from +
                  ' to ' +
                  window.to +
                  '. Spread suggestions across many DFW cities, not just one — include at least Dallas, Irving, Fort Worth, Plano, Frisco, Arlington, McKinney, Grand Prairie, Garland, Richardson, and Denton when you have good options there. Cover a VARIETY of categories: library storytimes (especially the Dallas Public Library and Irving Public Library systems), childrens museums and science museums, zoos and aquariums, petting farms, miniature trains, splash pads and spray parks, nature centers and preserves, botanical gardens, indoor play spaces, farmers markets, and free city family festivals. Include a healthy mix of INDOOR options (good for hot or rainy days) as well as outdoor. Prefer FREE options and list them first. Only include places/programs you are confident are real and currently operating, and provide their official website as source_url. Do NOT fabricate specific one-off dates you are unsure about — for recurring/ongoing things use null for event_date and set event_type to "recurring" or "attraction". Return JSON only: {"events":[{"title":string,"description":string,"event_date":"YYYY-MM-DD"|null,"start_time":"HH:MM"|null,"end_time":"HH:MM"|null,"venue_name":string,"city":string,"address":string|null,"is_free":boolean,"cost_text":string|null,"setting":"indoor|outdoor|both","category":"Storytime|Workshop|Animals/Farm|Train/Ride|Museum|Nature|Music|Festival|Other","min_age_months":number|null,"max_age_months":number|null,"event_type":"one_time|recurring|attraction","source_url":"https://..."}]}. Aim for 15 to 25 high-confidence items spread across different cities. If unsure about an item, omit it.'
              }
            ]
          }
        ]
